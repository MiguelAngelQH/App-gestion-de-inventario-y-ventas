            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.viewModel.ultimasVentas.isEmpty)
                      const Padding(
                      ...
                      ...widget.viewModel.ultimasVentas.asMap().entries.map(
                        (entry) => AnimatedListItem(
                          index: entry.key,
                          child: VentaItem(
                            folio: entry.value.folio,
                            cliente:
                                entry.value.clienteNombre ?? 'Cliente general',
                    ...
                    const SizedBox(height: 12),
                    if (widget.viewModel.topProductos.isEmpty)
                      const Padding(
                        padding: EdgeInsets.all(16),
                        child: Text(
                      ...
                      ...widget.viewModel.topProductos.asMap().entries.map(
                        (entry) => AnimatedListItem(
                          index: entry.key,
                          child: Card(
                            elevation: 0,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      Formatters.currency(
                                        entry.value.presentaciones.isNotEmpty
                                            ? entry
                                                  .value
                                                  .presentaciones
                                                  .first
        ...
        Row(
          children: [
            Expanded(
              child: MetricCard(
                titulo: 'Ventas Hoy',
                valor: Formatters.currency(widget.viewModel.totalVentasHoy),
                icono: Icons.today,
                color: const Color(0xFF00897B),
                subtitulo: '${widget.viewModel.ventasHoy} transacciones',
              ),
            ),
            ...
            Expanded(
              child: MetricCard(
                titulo: 'Esta Semana',
                valor: Formatters.currency(widget.viewModel.totalVentasSemana),
        ...
        Row(
          children: [
            Expanded(
              child: MetricCard(
                titulo: 'Stock Bajo',
                valor: '${widget.viewModel.productosStockBajo}',
            ...
            Expanded(
              child: MetricCard(
                titulo: 'Por Cobrar',
                valor: Formatters.currency(widget.viewModel.totalCuentasCobrar),
        ...
        Row(
          children: [
            Expanded(
              child: MetricCard(
                titulo: 'Por Pagar',
                valor: Formatters.currency(widget.viewModel.totalCuentasPagar),
