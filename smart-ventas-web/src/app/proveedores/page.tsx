    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-5">
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-[var(--text-primary)]">Nuevo Proveedor</h2>
            ...
            <input type="number" step="0.01" placeholder="Saldo pendiente" value={form.saldoPendiente} onChange={e => setForm({ ...form, saldoPendiente: parseFloat(e.target.value) || 0 })} className="w-full" />
      ...
      {pagoOpen && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-[var(--text-primary)]">Registrar Pago a Proveedor</h2>
      ...
      {editOpen && editProveedor && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-[var(--text-primary)]">Editar Proveedor</h2>
            ...
            <input type="number" step="0.01" placeholder="Saldo pendiente" value={editForm.saldoPendiente} onChange={e => setEditForm({ ...editForm, saldoPendiente: parseFloat(e.target.value) || 0 })} className="w-full" />
            <label className="text-sm text-[var(--text-muted)]">Fecha de vencimiento</label>
